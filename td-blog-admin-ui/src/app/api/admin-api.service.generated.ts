...
export class AdminApiAuthApiClient {
     ...
     * @return Success
     */
    login(body?: LoginRequest | undefined): Observable<AuthenticateResult> {
    ...
    protected processLogin(response: HttpResponseBase): Observable<AuthenticateResult> {
...
export class AdminApiTokenApiClient {
     ...
     * @return Success
     */
    refresh(body?: TokenRequest | undefined): Observable<AuthenticateResult> {
    ...
    protected processRefresh(response: HttpResponseBase): Observable<AuthenticateResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
