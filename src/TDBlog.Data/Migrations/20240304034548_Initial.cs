        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ToSatatus = table.Column<int>(type: "int", nullable: false),
                    DateCreated = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PostActibityLogs", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Descripttion = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    ...
                    DateCreated = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DateteModified = table.Column<DateTime>(type: "datetime2", nullable: true),
